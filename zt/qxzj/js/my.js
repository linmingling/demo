...
$(".box2-2-tag div").eq(2).hover(
	function () {
		if(new Date()>new Date(Date.parse('2015/08/29')))
		{
			var _live=$('#live3');
...
function pic(type){
	...
	var sj='<img src="upload/tianjin-1.jpg">\
			<img src="upload/tianjin-1.jpg">\
			<img src="upload/tianjin-1.jpg">\
			<img src="upload/tianjin-1.jpg">\
			<img src="upload/tianjin-1.jpg">\
			<img src="upload/tianjin-1.jpg">';
...
function qie(type){
	...
	for(var i=0;i<$("#imgurl img").length;i++){
		//alert($("#imgurl img").eq(i).css('display'));
		if($("#imgurl img").eq(i).css('display')=='block'||$("#imgurl img").eq(i).css('display')=='inline')
		{
			index=i;
...
// 	//alert($(obj).find('.box2-2-con').length*170-100);
//     $(obj).animate({
//         marginTop: "-580px"
//     }, 8000, function() {
...
//     var myar = setInterval('AutoScroll("#live1")', 1000)
    

//     //$(".gun").hover(function() { clearInterval(myar); }, function() { myar = setInterval('AutoScroll(".gun")', 1000) }); 
