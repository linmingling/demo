...
yt.init = function () {
    ...
    window.onload = function () {
        ...
        mySwiper1 = $("#swiper1 .swiper-container2").swiper({
            mode: 'horizontal',
            loop:true ,
            autoplay:4000,
            onSlideChangeEnd: function () {
                //$("#fy1").text($('.swiper-slide-active').attr('zdy'));
        ...
        mySwiper2 = $("#swiper2 .swiper-container2").swiper({
            mode: 'horizontal',
            loop:true ,
            autoplay:4000,
            onSlideChangeEnd: function () {
        ...
        mySwiper3 = $("#swiper3 .swiper-container2").swiper({
            mode: 'horizontal',
            loop:true ,
            autoplay:4000,
            onSlideChangeEnd: function () {
        ...
        mySwiper4 = $("#swiper4 .swiper-container2").swiper({
            mode: 'horizontal',
            loop:true ,
            autoplay:4000,
            onSlideChangeEnd: function () {
