    ...
    $.fn.featureCarousel = function (options) {
        ...
        return $(this).each(function () {
            ...
            function move(direction)
            {
                ...
                if (direction) {
                    $newLeft.css("z-index", 9);
                    //$newLeft.css("border", "0px");
                    //$newLeft.css("border-radius", "0px");
                } else {
                    $newRight.css("z-index", 9);
                   // $newRight.css("border", "0px");
                   // $newRight.css("border-radius", "0px");
                }
                $newCenter.css("z-index", 10);
                //$newCenter.css("border", "solid 10px rgba(255,255,255,0.1)");
                //$newCenter.css("border-radius", "10px");
