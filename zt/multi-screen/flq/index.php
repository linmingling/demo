								...
								<div class="scene_box">
									<div class="swiper-container am am2 animation an2" id="swiper-container-2" data-item="an2" data-delay="400" data-animation="bounceInRight">
										<div class="swiper-wrapper">
											...
											<div class="swiper-slide cf"><img src="images/scene/cf1.png" alt="餐厅" class="swiper-img"></div>
					...
					<div class="swiper-slide page-3">
					  <div class="container">
							<div class="wraper kt_box" id="kt">
								<div class="scene_title">
									<div class="am am1 animation an1" data-item="an1" data-delay="200" data-animation="bounceInLeft">
										<p class="big">帮忙<span>挑选客厅墙面漆~</span></p>
										<p>用手机挑选墙面漆，帮助成功，就有机会得到神秘礼物哦</p>
									</div>
								</div>
								...
								<div class="person_box am am3 " >
									...
									<div class="dialog animation an4" data-item="an4" data-delay="1400" data-animation="bounceIn">
										<div class="dialog_box">
											...
											<p><i class="red">哪</i><i class="red">套</i><i class="red">墙</i><i class="red">面</i><i class="red">漆</i><i>适</i><i>合</i><i>我</i><i>？</i></p>
										...
										<div class="dialog_box hide">
											...
											<p class="small">一菲喜欢深灰色的墙面漆</p>
											<img src="images/scene/false.png" class="tipsImg"/>
										</div>
										<div class="dialog_box hide">
											<p><i>哈哈！我喜欢这款颜色的墙面漆，</i></p>
					...
					<div class="swiper-slide page-4">
						<div class="container">
							<div class="wraper cf_box" id="cf">
								<div class="scene_title">
									<div class="am am1 animation an1" data-item="an1" data-delay="200" data-animation="bounceInLeft">
										<p class="big">帮忙<span>挑选餐厅墙面漆~~</span></p>
										<p>用手机挑选墙面漆，帮助成功，就有机会得到神秘礼物哦</p>
									</div>
								</div>
								<div class="scene_box am am2 animation an2" data-item="an2" data-delay="400" data-animation="bounceInRight">
								...
								<div class="person_box am am3 " >
									...
									<div class="dialog animation an4" data-item="an4" data-delay="1400" data-animation="bounceIn">
										...
										<div class="dialog_box hide">
											<p><i>这款颜色我不喜欢</i></p>
											<p><i class="red">再帮我看看其它款</i></p>
											<p class="small">小贤是帮女孩挑选颜色哦。</p>
											<img src="images/scene/false.png" class="tipsImg"/>
										</div>
										<div class="dialog_box hide">
											<p><i>这款颜色不适合哦！</i></p>
											<p><i class="red">女孩喜欢什么颜色？</i></p>
											<p class="small">小贤是帮女孩挑选颜色哦。</p>
											<img src="images/scene/false.png" class="tipsImg"/>
										</div>
										<div class="dialog_box hide">
					...
					<div class="swiper-slide page-5">
					  <div class="container">
							<div class="wraper ws_box" id="ws">
								<div class="scene_title">
									<div class="am am1 animation an1" data-item="an1" data-delay="200" data-animation="bounceInLeft">
										<p class="big">帮忙<span>挑选卧室墙面漆~</span></p>
										<p>用手机挑选墙面漆，帮助成功，就有机会得到神秘礼物哦</p>
									</div>
								</div>
								<div class="scene_box am am2 animation an2" data-item="an2" data-delay="400" data-animation="bounceInRight">
								...
								<div class="person_box am am3 " >
									...
									<div class="dialog animation an4" data-item="an4" data-delay="1400" data-animation="bounceIn">
										<div class="dialog_box">
											<p><i>你好，帮我快看看！</i></p>
											<p><i class="red">哪款墙面漆</i><i>适</i><i>合</i><i>我</i><i>？</i></p>
											<p class="small">提供三套款式，请用手机挑选</p>
										</div>
										<div class="dialog_box hide">
											<p><i>这款颜色我不喜欢</i></p>
											<p><i class="red">再帮我看看其它款</i></p>
											<p class="small">悠悠喜欢有温馨的颜色</p>
											<img src="images/scene/false.png" class="tipsImg"/>
										</div>
										<div class="dialog_box hide">
											<p><i>这款不错但是不配我</i></p>
											<p><i class="red">我喜欢咖啡的颜色</i></p>
											<p class="small">悠悠喜欢有巧克力的颜色</p>
											<img src="images/scene/false.png" class="tipsImg"/>
										</div>
										<div class="dialog_box hide">
											<p><i>亲爱的！我喜欢这套，</i></p>
											<p><i class="red">这颜色浓浓的！</i></p>
