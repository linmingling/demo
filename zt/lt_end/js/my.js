...
yt.app = function () {
    ...
    var onSlideChangeEnd = function () {
       if(mySwiper.activeIndex == 5){
            num_change(60000,1000,'num1',10,2500);
            num_change(100000,1000,'num2',10,2500);
            num_change(4.2,0.2,'num3',4,2500);
            num_change(5,1,'num4',4,2500);
       }
       if(mySwiper.activeIndex == 6){
            num_change(20,10,'num5',10,2500);
