...
if($_POST){
	...
	if($act == "trial"){
		...
		if($arr){
			...
			$sql = "INSERT INTO bri_sign_trial(name, phone, city, choose, source, add_time, add_strtotime) VALUES('".$name."','".$phone."','".$city."','".$select."','mobile','".$add_time."','".$add_strtotime."')";
			$url = mysqli_query($db, $sql);
	...
	if($act == "apply"){
		...
		if($arr){
			...
			$sql = "INSERT INTO bri_sign_apply(name, phone, sex, city, address, type, ishealth, issmoking, isdec, isanimal, isclean, xy, source, add_time, add_strtotime) VALUES('".$name."','".$phone."','".$sex."','".$city."','".$address."','".$types."','".$ishealth."','".$issmoking."','".$isdec."','".$isanimal."','".$isclean."','".$xy."','mobile','".$add_time."','".$add_strtotime."')";
			$url = mysqli_query($db, $sql);
