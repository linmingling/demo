...
yt.content = function () {
    ...
    var bindAms = function () {
        ...
        var am1 = function () {
            ...
            t7.from($nav, 1, { autoAlpha: 0, left: -1000,  ease: Back.easeOut });
            t1.from($c1m1, 1, { autoAlpha: 0, left: -150,  delay: 0.4 });
            t2.from($c1m2, 1, { autoAlpha: 0, right: -150,  delay: 0.5 });
            t3.from($c1m3, 1, { autoAlpha: 0, bottom: -100,  delay: 0.9 });
            t4.from($c1m4, 1, { autoAlpha: 0, left: -50,  delay: 1.3 });
