...
yt.app = function () {
    ...
    var bindNext = function () {
        ...
        $(".sub-btn").on("click",function(){
            var bedten = parseInt($('#bedten').val());
            var bedone = parseInt($('#bedone').val());
            var timesten = parseInt($('#timesten').val());
            var timesone = parseInt($('#timesone').val());

            bedten = isNaN(bedten) ? 0 : bedten*10;
            bedone = isNaN(bedone) ? 0 : bedone;
            timesten = isNaN(timesten) ? 0 : timesten*10;
            timesone = isNaN(timesone) ? 0 : timesone;

            bed = bedten + bedone;
            times = timesten + timesone;
            ...
            var getpersent = parseFloat(bed/times);
            if(getpersent<=1)
            {
                mySwiper.swipeTo(5);
                return false;
