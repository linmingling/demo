...
yt.app = function () {
   ...
   //初始化
    ...
    $(".get-tips").click(function(){
        var showTips = '';
        showTips=$(this).attr("data");
        //console.log(showTips);
        
        $("#tips-box").empty();
        $("#tips-box").append("<img src='images/ans"+showTips+".png' />");
    ...
    $(".select-ans").click(function(){
        ...
        $(".ps3 .am"+selAns).removeClass("selected");
        
        if(selAns == $(this).attr("data")){
            selAns=0;
            pAns='';
        }
        else{
            selAns=$(this).attr("data");
            pAns=$(this).attr("ans");
        }
    ...
    $("#infoSubmit").click(function(){
        ...
        $.ajax({
            async:false,
            url: 'server.php',
            data:{act:'add',name:na,phone:phone,answer:pAns},
            type: "post",
            dataType:'json',
            success:function(result){
                //数据返回后执行
...
$("#name").on("click",function(){
    //alert(123);
    $("#name").focus();
    // $(".ps4 .container").addClass("scrollTop");
});
...
$('#name').blur(function () { 
    ...
    // $(".ps4 .container").removeClass("scrollTop");
}) 
