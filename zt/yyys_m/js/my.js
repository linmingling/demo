...
yt.app = function () {
    ...
    $("#pz1-close").bind('click',function(e){
        $("#pz1-close").hide();
        $("#pz1-open").slideDown();

    })
    $("#pz1-open").bind('click',function(e){
        $("#pz1-open").slideUp(function(){$("#pz1-close").show();});
    })

    $("#pz2-close").bind('click',function(e){
        $("#pz2-close").hide();
        $("#pz2-open").slideDown();

    })
    $("#pz2-open").bind('click',function(e){
        $("#pz2-open").slideUp(function(){$("#pz2-close").show();});
    })

    $("#pz3-close").bind('click',function(e){
        $("#pz3-close").hide();
        $("#pz3-open").slideDown();

    })
    $("#pz3-open").bind('click',function(e){
        $("#pz3-open").slideUp(function(){$("#pz3-close").show();});
    })
