...
var C = {
        H: "",
        Р: Ѕ("images/phone-0.png"),
        C: Ѕ("images/phone-0.png"),
...
var p = [
        ...
        {
            id: "title",
            //src: "http://local.zt/shu/images/title.png"
            src: "images/bg.jpg"
        },
        {
            id: "help",
            //src: "http://local.zt/shu/images/help.png"
            src: "images/bg.jpg"
        },
        {
            id: "number",
...
var M = Best.hg.extend({
        ...
        update: function (B, X) {
			//console.log(Math.min(0.3, this.Β8 + 0.02));
