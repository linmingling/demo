...
$pv=rand(20,25)+$info_arr['page_view'];
$info_sql = "UPDATE live SET page_view=".$pv ." WHERE id=".$id;
$info = mysqli_query($db, $info_sql);
...
<html>
	<head>
	    ...
	    <meta name="author" content="腾讯家居">
	    <meta name="Copyright" content="腾讯家居">
    ...
    <section class="warp">
		<header class="header">
			...
			<div style="width: 600px;margin-top:10px;text-align: center;">
				<span style="background:none;color:#5291d2;font-family:microsoft yahei;margin-top:15px">参与人数:<?php echo $info_arr['page_view']?></span>
			</div>
		</header>
