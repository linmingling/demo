...
$(document).ready(function(){
    ...
    $(".nav ul li").eq(1).click(function(event) {
        $('html,body').stop().animate({ scrollTop: 1460}, 500)
    });
    $(".nav ul li").eq(2).click(function(event) {
        $('html,body').stop().animate({ scrollTop: 2015}, 500)
    });
    $(".nav ul li").eq(3).click(function(event) {
        $('html,body').stop().animate({ scrollTop: 2805}, 500)
    });
    $(".nav ul li").eq(4).click(function(event) {
        $('html,body').stop().animate({ scrollTop: 3600}, 500)
    });
    $(".nav ul li").eq(5).click(function(event) {
        $('html,body').stop().animate({ scrollTop: 4404}, 500)
    });
    ...
    $(".prev").click(function(event) {
        phonenumb++;
        if(phonenumb>2){phonenumb=0};

        var phoneright=phonenumb+1;
        if (phoneright>2) {phoneright=0};
        var phoneleft=phonenumb-1;
        if(phoneleft>2){phoneleft=0};
        $(".phoneshow ol li").eq(phonenumb).show().siblings().hide();
        $(".phone ul li").eq(phonenumb).removeClass().addClass('current').siblings().removeClass('current');
        $(".phone ul li").eq(phoneright).removeClass().addClass('nextphone').siblings().removeClass('nextphone')
        $(".phone ul li").eq(phoneleft).removeClass().addClass('prevphone').siblings().removeClass('prevphone')
    });

    $(".next").click(function(event) {
        phonenumb--;
        if(phonenumb<0){phonenumb=2}
        var phoneright=phonenumb+1;
        if(phoneright<0){phoneright=1};
        var phoneleft=phonenumb-1;
        if(phoneleft<0){phoneleft=2}
        $(".phoneshow ol li").eq(phonenumb).show().siblings().hide();
        $(".phone ul li").eq(phonenumb).removeClass().addClass('current').siblings().removeClass('current');
        $(".phone ul li").eq(phoneright).removeClass().addClass('nextphone').siblings().removeClass('nextphone')
        $(".phone ul li").eq(phoneleft).removeClass().addClass('prevphone').siblings().removeClass('prevphone');
    ...
    var citynumb=0
     $(".cityprev").click(function(event) {
       citynumb--;
       if(citynumb<0){citynumb=0}
        $(".maincity").stop().animate({left:-84*citynumb},500) 
    });
    $(".citynext").click(function(event) {
        citynumb++;
        if(citynumb>1){citynumb=1}
        $(".maincity").stop().animate({left:-84*citynumb},500) 
    });
    $(".way").click(function(){
        $(".timershow").show(300)
