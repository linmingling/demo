...
yt.app = function () {
    ...
    var onSlideChangeEnd = function () {
        ...
        if(mySwiper.activeIndex == 4 && flag == 0){
           $("#lotteryContainer").addClass("hover");
           $(".cn-slidetips").hide()
        }
        onSlideChange();
    };
   ...
   //初始化
    ...
    $("#ps3").swipeLeft(function(){
        $("#ps3 .am4").animate({"filter":"alpha(opacity=1)","-moz-opacity":"1","opacity":"1"},500,function(){
            $("#ps3 .am5").animate({"filter":"alpha(opacity=1)","-moz-opacity":"1","opacity":"1"},500)
            $("#ps3 .am3 span").css("z-index","1")
        });
