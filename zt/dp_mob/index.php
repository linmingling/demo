...
<div class="swiper-container swiper-pages" id="swiper-container1">
	<div class="swiper-wrapper" id="wrapper">
		  ...
		  <!-- <div class="swiper-slide page-1 ps1">
		  			  <div class="container">
		  					<div class="am am1">
		  						...
		  						<img src="images/p1_3.png" class="animation an1 goto" goto="1" data-item="an1" data-delay="200" data-animation="bounceIn" />
		  						<img src="images/p1_4.png" class="animation an1 goto" goto="3" />
		  						<img src="images/p1_2.png" class="animation an1" goto="9" />
		  						<img src="images/p1_5.png" class="animation an1" goto="13" />
		  					</div>
		  					
		  			  </div>
		  </div> -->

		  <div class="swiper-slide page-1 ps2">
			  <div class="container">
					<div class="am am1">
		  ...
		  <div class="swiper-slide page-2 ps3">
			  <div class="container">
					<div class="am am1">
						<img date-src="images/p2_1.png" />
						<img date-src="images/p3_2.png?v=1.0" class="animation an2" data-item="an2" data-delay="200" data-animation="bounceIn"/>
					</div>
				
			  </div>                
		  </div>
		  
		  <div class="swiper-slide page-3 ps4">
			  <div class="container">
					<div class="am am1">
		  ...
		  <div class="swiper-slide page-4 ps5">
			  <div class="container">
					<div class="am am1">
						<img date-src="images/p4_1.png" />
		  ...
		  <div class="swiper-slide page-5 productBox ps6">
			  <div class="container">
					<div class="am am1">
		  ...
		  <div class="swiper-slide page-6 productBox ps7">
			  <div class="container">
					<div class="am am1">
						<img date-src="images/p7_1.png" />
					</div>
					<div class="am am2">
						<img date-src="images/p7_2.jpg?v=1.0" />
						<div class="icon icon1"></div>
						<div class="icon icon2"></div>
						<div class="icon icon3"></div>
						<div class="icon icon4"></div>
		  ...
		  <div class="swiper-slide page-7 productBox ps8">
			  <div class="container">
					<div class="am am1">
		  ...
		  <div class="swiper-slide page-8 productBox ps9">
			  <div class="container">
					<div class="am am1">
		  ...
		  <div class="swiper-slide page-9 ps13">
			  <div class="container">
					<div class="am am1">
...
<script>
	...
	wx.ready(function () {
		var wxData = {
			...
			"link":'http://zt.jia360.com/dp_mob/index.php',
...
(function() {
  ...
  hm.src = "//hm.baidu.com/hm.js?22e0d0e25d388f4add9f8fa724f58a5f";
