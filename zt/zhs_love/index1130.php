...
<div class="swiper-container n_wrapper Mc_bg" id="SwiperModule">
    <img src="images/Mc_logo.png" id="Mc_logo"/></p>
    <p><div id="Ani_arrow"></div></p>
    <div class="swiper-wrapper n_wrapper">
            ...
            <div class="ver n_wrapper">
                <div id="ContentBox">
                    <p class="ani" swiper-animate-effect="fadeIn" swiper-animate-duration="0.6s"
                       swiper-animate-delay="0s"><img src="images/Mc_bg_content1.jpg" id="Mc_bg_content"/></p>

                    <p class="ani" swiper-animate-effect="zoomIn" swiper-animate-duration="0.3s"
                       swiper-animate-delay="0.2s" id="Mc_cir"><img src="images/Mc_cir.png"></p>

                    <p class="ani" swiper-animate-effect="fadeInDown" swiper-animate-duration="0.6s"
                       swiper-animate-delay="0.8s" id="Mc_tit"><img src="images/Mc_tit1.png"/></p>

                    <p class="ani" swiper-animate-effect="fadeInDown" swiper-animate-duration="1.2s"
                       swiper-animate-delay="1.4s" id="Mc_txt_Fir"><img src="images/Mc_txt_Fir1.png"/></p>

                    <p class="ani" swiper-animate-effect="fadeInDown" swiper-animate-duration="1.2s"
                       swiper-animate-delay="2s" id="Mc_txt_Sec"><img src="images/Mc_txt_Sec1.png"/></p>

                    <p class="ani" swiper-animate-effect="fadeInDown" swiper-animate-duration="1.2s"
                       swiper-animate-delay="2.6s" id="Mc_txt_Thr"><img src="images/Mc_txt_Thr1.png"/></p>

                    <p class="ani" swiper-animate-effect="fadeInDown" swiper-animate-duration="1.2s"
                       swiper-animate-delay="3.2s" id="Mc_txt_Fou"><img src="images/Mc_txt_Fou1.png"/></p>

                    <p class="ani" swiper-animate-effect="fadeIn" swiper-animate-duration="0.5s"
                       swiper-animate-delay="4s"><img src="images/Mc_line.png" id="LineFir"/></p>

                    <p class="ani" swiper-animate-effect="fadeIn" swiper-animate-duration="0.5s"
                       swiper-animate-delay="4s"><img src="images/Mc_line.png" id="LineSec"/></p>

                    <p class="ani" swiper-animate-effect="fadeIn" swiper-animate-duration="0.5s"
                       swiper-animate-delay="4s"><img src="images/Mc_line.png" id="LineThr"/></p>
                </div>

            </div>
        </div>
        <div class="swiper-slide n_wrapper swiper-no-swiping unShow" id="SlidePage4">
            <div class="n_wrapper">
        ...
        <div class="swiper-slide n_wrapper swiper-no-swiping" id="SlidePage5">
            <div class="n_wrapper ver Mc_bg_rule">
                <div id="RuleBox">
