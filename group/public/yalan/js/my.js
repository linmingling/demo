...
yt.app = function () {
    ...
    var onSlideChangeEnd = function () {
        ...
        var hmID = "yl_PV_" + page;
        // console.log(hmID)
        _hmt.push(['_trackEvent', '雅兰', 'yl_滑屏PV', hmID]);
   ...
   //初始化
    ...
    $(".click_btn").click(function(){
        ...
        // 百度统计
        var page = mySwiper.activeIndex+1;
        var hmID = "yl_Page_" + page;
        // console.log(hmID);
        _hmt.push(['_trackEvent', '雅兰', 'yl_0元领票按钮', hmID]);
  ...
  // 领票弹出
    $("#baoming .lpBtn").click(function(){
        // 百度统计
        var hmID = "yl_Page_lpBtn";
        // console.log(hmID);
        _hmt.push(['_trackEvent', '雅兰', 'yl_提交用户信息', hmID]);
    ...
    $("#baoming .getCode").click(function(){
        // 百度统计
        var hmID = "yl_Page_getCode";
        // console.log(hmID);
        _hmt.push(['_trackEvent', '雅兰', 'yl_重新获取验证码', hmID]);
    ...
    $("#baoming .bmBtn").click(function(){
        // 百度统计
        var hmID = "yl_Page_bmBtn";
        // console.log(hmID);
        _hmt.push(['_trackEvent', '雅兰', 'yl_提交地址信息', hmID]);
