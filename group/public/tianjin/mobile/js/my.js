...
yt.app = function () {
    ...
    //滑动1 绑定内页滑动函数
    var bindSwiper1 = function () {
        mySwiper2 = $("#swiper1 .swiper-container").swiper({
            mode: 'horizontal',
    ...
    var bindSwiper2 = function () {
        mySwiper3 = $("#swiper2 .swiper-container").swiper({
            mode: 'horizontal',
            //mousewheelControl:true,
            //grabCursor: true,
            loop:true,
    ...
    var bindSwiper4 = function () {
        mySwiper4 = $("#swiper4 .swiper-container").swiper({
            mode: 'horizontal',
            //mousewheelControl:true,
            //grabCursor: true,
            loop:true,
...
/*	$('.adImg').click(function(){
		...
		$.ajax({
			async:true,
			url:'/phone/shex/goods_click',
			data:{btn_id:btn_id,tel:tel},
			type: 'post',
			dataType:'json',
			success:function(result){
				location.href = url;
