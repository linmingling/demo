...
class HebController extends ControllerBase {
    ...
    public function initialize(){
        ...
        $this->jssdk = new \Library\Com\Share();
    }
    ...
    public function submitAction(){
        ...
        if(!empty($data)){
            ...
            $sql = "INSERT INTO heb (name, phone, btn_id, add_time) VALUES('".$name."','".$phone."','".$btn_id."','".time()."')";
    ...
    public function clickAction(){
        if($this->request->isAjax()){
            ...
            $sql = "INSERT INTO heb_budian (btn_id, add_time) VALUES('".$id."','".time()."')";
            $this->group->execute($sql);
        }
    }
